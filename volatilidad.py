...
saldos_cuentas_depositos_original_df = pd.read_excel("./Downloads/wilmer/insumos/volatilidad.xls", usecols="B:F")
...
scdr_df = np.log(scdc2_df.divide(scdc1_df)).fillna(0)
